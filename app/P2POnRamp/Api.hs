...
type API =
    "seller-data"
        :> ReqBody '[JSON] SellerData
        :> Post '[JSON] NewOrder
        :<|> "sell-build"
            :> ReqBody '[JSON] SellerTx
            :> Post '[JSON] SellTxResponse
        :<|> "sell-submit"
            :> ReqBody '[JSON] AddSubmitParams
        ...
        :<|> "buy-build"
            :> ReqBody '[JSON] BuyCommit
            :> Post '[JSON] UnsignedTxResponse
        :<|> "buy-submit"
            :> ReqBody '[JSON] AddSubmitParams
            :> Post '[JSON] SubmitTxResult
        :<|> "fiat-verify"
            :> ReqBody '[JSON] FiatVerify
            :> Post '[JSON] FiatVerified
        :<|> "claim-build"
            :> ReqBody '[JSON] ClaimCrypto
...
app ctx path =
    cors (const $ Just simpleCorsResourcePolicy{corsRequestHeaders = ["Content-Type"], corsMethods = ["GET", "POST", "PUT", "OPTIONS"], corsOrigins = Nothing}) $
        serve appApi $
